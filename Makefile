...
CC=mpicc
#Intel Compiler
#CFLAGS=-openmp -ipo -O3 -no-prec-div -xHost -IGPI2/src -DONE_SIDED
#CFLAGS=-openmp -ipo -O3 -no-prec-div -xHost -IGPI2/src
# GCC
#CFLAGS=-fopenmp -O2 -IGPI2/src -DONE_SIDED
CFLAGS=-fopenmp -O2 -IGPI2/src -DTHREADS=8

LFLAGS=-LGPI2/lib64/ -lGPI2 -libverbs
